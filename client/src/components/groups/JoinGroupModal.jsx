...
export function JoinGroupModal({ open, onClose, onJoin }) {
  ...
  return createPortal(
    <div style={styles.overlay} onClick={handleOverlayClick}>
      <div style={styles.card} role="dialog" aria-modal="true" aria-labelledby="join-group-title">
        <h2 id="join-group-title" style={styles.title}>Join a group</h2>
